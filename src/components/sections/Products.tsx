    ...
    <section id="products" className="py-24 bg-zinc-900">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
             <h2 className="text-3xl md:text-5xl font-bold mb-2">
              Nossos <span className="text-yellow-600">Produtos</span>
            </h2>
            <p className="text-zinc-400">
              Soluções completas para sua linha de produção.
            </p>
          </div>
          <button className="hidden md:block px-6 py-2 border border-zinc-700 rounded-full hover:bg-yellow-600 hover:border-yellow-600 hover:text-white transition-all text-zinc-400">
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                <span className="inline-block px-3 py-1 bg-yellow-600 text-white text-xs font-bold rounded-full mb-3">
                  {product.tag}
                </span>
        ...
        <div className="mt-8 text-center md:hidden">
           <button className="px-6 py-2 border border-zinc-700 rounded-full hover:bg-yellow-600 hover:border-yellow-600 hover:text-white transition-all text-zinc-400">
            Ver Catálogo Completo
          </button>
        </div>
      </div>
